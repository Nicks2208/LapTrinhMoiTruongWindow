...
namespace List_Student
{
    internal class DSSV
    {
        ...
        {
            new Student(01, "Pham Minh Nhat", 17),
            new Student(02, "Anh Phan Huy", 18),
            new Student(03, "Tran Minh Hieu", 20),
            new Student(04, "Pham Thanh An",16),
            new Student(05, "Phan Van Hai", 19)
        };
